    ...
    <table>
      ...
      while ($row = $result->fetch_assoc()) {
        ...
        <tr>
          ...
          <td>
            <?php if (!empty($row["bukti_img"])): ?>
              <img src="./upload/bukti/<?php echo $row["bukti_img"]; ?>" alt="Bukti Pembayaran"
