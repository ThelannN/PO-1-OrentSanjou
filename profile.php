            ...
            <table style="border-collapse: collapse; text-align: center; ">
              <thead>
                <tr>
                  ...
                  <th style='background-color: skyblue; padding: 10px; font-size: 18px; text-align: center'>Returned
                    Status</th>
                  ...
                  while ($row10 = $result10->fetch_assoc()) {
                    ...
                    <tr>
                      <form action='<?php echo $_SERVER['PHP_SELF'] ?>?bid=<?php echo $row10['bid'] ?>' method='post'>
                        <td style="padding: 10px; width:30%; font-weight: bold;">
                          <h5><?php echo $sn ?></h5>
                        </td>
                        <td style="padding: 10px; width:30%; font-weight: bold;"><img class='image'
                            style="height:50px;width:50px" src="admin/upload/<?php echo $row11['book_img'] ?>" alt="book-img">
                        </td>
                        <td style="padding: 10px; width:30%; font-weight: bold;">
                          <h5><?php echo $row11['book_title'] ?></h5>
                        </td>
                        <td style="padding: 10px; width:30%; font-weight: bold;"><input type="text" name='quant'
                            value='<?php echo $row10['quantity'] ?>' readonly
                            style='outline:none;border:none;width:100%;background:none'></td>
                        <td style="padding: 10px; width:30%; font-weight: bold;">
                          <h5>Rs <?php echo $row10['price'] * $row10['quantity'] ?></h5>
                        </td>
                        <td style="padding: 10px; width:30%; font-weight: bold;">
                          <h5><?php echo $row10['date'] ?></h5>
                        </td>
                        <td style="padding: 10px; width:30%; font-weight: bold;"><input type='date' name='r_date'
                            value='<?php echo $row10['return_date'] ?>' readonly
                            style='outline:none;border:none;width:100%;background:none'></td>
                        <td style="padding: 10px; width:30%; font-weight: bold;">
                          <h5><?php
                        ...
                        <td style="padding: 10px; width:30%; font-weight: bold;">
                          <h5><?php echo $row10['delivered_status'] ?>
                        ...
                        <td style="padding: 10px; width:30%; font-weight: bold;">
                          <h5>
                            <?php if ($row10['delivered_status'] === 'delivered' and $row10['returned_status'] === 'pending')
                              echo "<button name='send_request' type='submit' style='background:grey;border:none;font-size:12px'  class='btn'>return request</button>" ?>
...
') ?>
      ...
      ?>
          ...
          <tbody>
            <form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="POST">
              <tr>
                ...
                <td style="padding: 10px; width:50%;"><input type='text' name='name'
                    value="<?php echo $row['customer_name'] ?>" style="margin: 0;position:relative">
                  <?php
              ...
              <tr>
                ...
                <td style="padding: 10px; width:50%;"><input type='email' name='email'
                    value="<?php echo $row['customer_email'] ?>" style="margin: 0;"></input></td>
              </tr>
              <tr>
                <td style="padding: 10px; width:30%; font-weight: bold;">
                  <h5> Password:</h5>
                </td>
                <td style="padding: 10px; width:50%;"><input type='text' name='pwd'
                    value="<?php echo $row['customer_pwd'] ?>" style="margin: 0;"></input></td>
              </tr>
              <tr>
                <td style="padding: 10px; width:30%; font-weight: bold;">
                  <h5>Phone:</h5>
                </td>
                <td style="padding: 10px; width:50%;"><input type='number' maxlength='10' name='phone'
                    value="<?php echo $row['customer_phone'] ?>" style="margin: 0;"></input></td>
              <tr>
                <td style="padding: 10px; width:30%; font-weight: bold;">
                  <h5>Address:</h5>
                </td>
                <td style="padding: 10px; width:50%;"><input type='text' name='address'
                    value="<?php echo $row['customer_address'] ?>" style="margin: 0;"></input></td>
              </tr>
              </tr>
              <tr>
                <td style="padding: 10px; width:30%; font-weight: bold;">
        ...
        <h3 style='text-align:center'> <a style='' href="./profile.php?id=<?php echo $_SESSION['id'] ?>">Book Rented
            History</a> </h3>
        <div style='border:1px solid skyblue;width:50%;text-align:center'></div>
        <?php
    } ?>
